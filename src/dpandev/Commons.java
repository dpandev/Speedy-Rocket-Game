...
public interface Commons {
    ...
    public static final double ALIEN_MOV_SPEED = 0.3;
    ...
    public static final double ROCKET_Y_LOCATION = SCREEN_HEIGHT/4;
    public static final double ROCKET_THRUST_DIFF = 10;
    public static final double ROCKET_RETURN_THRUST_DIFF = ROCKET_THRUST_DIFF/2;
    public static final double ROCKET_SPEED = 0.6;
